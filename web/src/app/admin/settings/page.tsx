...
const CARDS = [
  ...
  /* 29 ส.ค. 2569 · ค่าเซิร์ฟเวอร์อีเมลเคยอยู่ในไฟล์ตั้งค่าของเครื่อง ทีมที่ดูแลเว็บ
     แก้เองไม่ได้ ต้องรอทีมพัฒนาทุกครั้งที่เปลี่ยนผู้ให้บริการหรือรหัสหมดอายุ */
  { title: 'อีเมล', desc: 'ตั้งค่าเซิร์ฟเวอร์ส่งอีเมล — ใช้กับอีเมลเชิญเข้าระบบและลิงก์ตั้งรหัสผ่านใหม่', meta: 'เจ้าของระบบเท่านั้น · มีปุ่มส่งทดสอบ', href: '/admin/mail', iconBg: '#EEF4F3', icon: ic(<><path d="M22 6l-10 7L2 6" /><rect x="2" y="4" width="20" height="16" rx="2" /></>, '#034956') },
  ...
  /* สไลด์ 5 · "ทำตัว setup เรียงลำดับเมนูที่หลังบ้าน" — ลำดับเคยเขียนตายตัว
     ในโค้ด อยากสลับต้องรอรอบ deploy */
  { title: 'ลำดับเมนู', desc: 'จัดลำดับเมนูประเภททรัพย์บนแถบบนสุดของเว็บ', meta: 'ใช้กับทุกหน้า · จอใหญ่และมือถือ', href: '/admin/menu', iconBg: '#EEF4F3', icon: ic(<><path d="M3 6h18M3 12h18M3 18h18" /><path d="M8 3l-3 3 3 3" /></>, '#034956') },
