...
const mediaCss = `
@media (max-width:1100px){ #media-layout{grid-template-columns:1fr !important;} #media-folders{display:none !important;} }
@media (max-width:640px){ #media-grid{grid-template-columns:repeat(2,1fr) !important;} }
`;

const mediaActions = (
  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
    <a href="/admin/sections" style={{ display: 'flex', alignItems: 'center', gap: 7, height: 40, padding: '0 16px', borderRadius: 9999, background: 'var(--surface)', border: '1px solid var(--border)', color: 'var(--text)', fontSize: 13, fontWeight: 700, whiteSpace: 'nowrap' }}>
