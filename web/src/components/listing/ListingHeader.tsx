      ...
      >
        ...
        >
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: 26 }}>
            ...
            <a className="nav-link" href="/faq" style={{ fontSize: 14, fontWeight: 500, color: 'var(--muted)' }}>คำถามพบบ่อย</a>
            <a className="nav-link" href="/about" style={{ fontSize: 14, fontWeight: 500, color: 'var(--muted)' }}>เกี่ยวกับเรา</a>
