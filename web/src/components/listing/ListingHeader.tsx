      ...
      >
        ...
        >
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: 26 }}>
            ...
            <Link className="nav-link" href="/faq" style={{ fontSize: 14, fontWeight: 500, color: 'var(--muted)' }}>คำถามพบบ่อย</Link>
            <Link className="nav-link" href="/about" style={{ fontSize: 14, fontWeight: 500, color: 'var(--muted)' }}>เกี่ยวกับเรา</Link>
