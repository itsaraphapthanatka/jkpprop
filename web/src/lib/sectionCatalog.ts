  ...
  home: [
    ...
    },
    {
      ...
      items: {
        ...
        hint: 'ใส่เฉพาะที่มีหลักฐานจริง — การ์ดแต่ละใบติดป้าย “ตรวจสอบแล้ว” · ใส่โลโก้จริงได้ ถ้าไม่ใส่จะใช้ไอคอนตั้งต้น',
        fields: [
          /* เดิมการ์ดใช้ไอคอนที่วาดไว้ในโค้ดสามแบบตายตัว ตราของ TREBA หรือ DBD
             เป็นโลโก้ของหน่วยงานจริง วาดเลียนแบบไม่ได้ — ทีมอัปโหลดเองได้แล้ว */
          { key: 'img', label: 'โลโก้ / ตรารับรอง (เว้นว่าง = ใช้ไอคอนตั้งต้น)', kind: 'image' },
