...
export type Dictionary = {
  ...
  common: {
    ...
    home: string; noPhoto: string; confirm: string; million: string; tonPerSqm: string;
  };
  hero: {
  ...
  listing: {
    ...
    zone: string; province: string; district: string; subdistrict: string; searchPh: string; allOf: string; zoneColor: string; type: string; size: string; price: string; clear: string; search: string;
...
const th: Dictionary = {
  ...
  common: {
    ...
    apply: 'นำไปใช้', clear: 'ล้างค่า', home: 'หน้าแรก', noPhoto: 'ยังไม่มีรูป', confirm: 'ยืนยัน', million: 'ล้าน', tonPerSqm: 'ตัน/ตร.ม. ขึ้นไป',
  },
  hero: {
  ...
  listing: {
    ...
    zone: 'ทำเล', province: 'จังหวัด', district: 'เขต / อำเภอ', subdistrict: 'แขวง / ตำบล', searchPh: 'ค้นหาด้วยชื่อประกาศ ทำเล หรือรหัสทรัพย์', allOf: 'ทั้งหมด', zoneColor: 'พื้นที่สี (ผังเมือง)', type: 'ประเภทอสังหา', size: 'ขนาดพื้นที่', price: 'ช่วงราคา',
...
const en: Dictionary = {
  ...
  common: {
    ...
    apply: 'Apply', clear: 'Clear', home: 'Home', noPhoto: 'No photo yet', confirm: 'Confirm', million: 'million', tonPerSqm: 't/sqm or more',
  },
  hero: {
  ...
  listing: {
    ...
    zone: 'Location', province: 'Province', district: 'District', subdistrict: 'Subdistrict', searchPh: 'Search by name, area or property code', allOf: 'All', zoneColor: 'Zoning colour', type: 'Property type', size: 'Floor area', price: 'Price range',
...
const zh: Dictionary = {
  ...
  common: {
    ...
    apply: '应用', clear: '清除', home: '首页', noPhoto: '暂无照片', confirm: '确认', million: '百万', tonPerSqm: '吨/平方米以上',
  },
  hero: {
  ...
  listing: {
    ...
    zone: '地区', province: '府', district: '县/区', subdistrict: '分区', searchPh: '按名称、地区或房源编号搜索', allOf: '全部', zoneColor: '城市规划分区颜色', type: '房源类型', size: '建筑面积', price: '价格区间',
    clear: '清除', search: '搜索',
