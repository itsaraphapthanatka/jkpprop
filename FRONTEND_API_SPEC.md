...
type StoredLead = {
  ...
  phone: string;         // บังคับ — ฟอร์มไม่ให้ส่งถ้าเว้นว่าง
...
| ฟอร์มแจ้งความต้องการ | ต้องมี `phone` (บังคับทุกประเภททรัพย์) | กรุณากรอกเบอร์โทรศัพท์ เพื่อให้ทีมงานติดต่อกลับได้ |
