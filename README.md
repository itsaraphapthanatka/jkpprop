...
- **หน้าจอ index ของ deals / visits / shortlists** — ดีไซน์ที่อนุมัติมีแต่หน้ารายละเอียด
  ตอนนี้ใช้ตัวเลือกรายการบน topbar แทน (URL รับ `/<id>` แล้ว)
- **รูปในการ์ด/แกลเลอรียังเป็น `<img>`** — โลโก้ผ่าน `next/image` แล้ว แต่รูปที่จัดขนาดด้วย CSS
  (`objectFit: cover`) ต้องรื้อโครง container ก่อน จึงยังไม่แปลง
- **Header ซ้ำ 4 ชุด (~1,460 บรรทัด)** — home / listing / property / content ยัง re-implement nav เดียวกัน
